 ...
 *
 * Usage: tsx delete-post-model-test.ts <projectDir>
 */
...
if (!dir) {
  process.stderr.write("usage: delete-post-model-test.ts <projectDir>\n");
  process.exit(2);
}
const target = resolve(dir, "tests/models/Post.test.ts");
