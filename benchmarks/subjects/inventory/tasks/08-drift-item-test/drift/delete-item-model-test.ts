 ...
 *
 * Usage: tsx delete-item-model-test.ts <projectDir>
 */
...
if (!dir) {
  process.stderr.write("usage: delete-item-model-test.ts <projectDir>\n");
  process.exit(2);
}
const target = resolve(dir, "tests/models/Item.test.ts");
