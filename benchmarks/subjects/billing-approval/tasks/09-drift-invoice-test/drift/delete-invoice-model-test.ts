 ...
 *
 * Usage: tsx delete-invoice-model-test.ts <projectDir>
 */
...
if (!dir) {
  process.stderr.write("usage: delete-invoice-model-test.ts <projectDir>\n");
  process.exit(2);
}
const target = resolve(dir, "tests/models/Invoice.test.ts");
