 ...
 *
 * Usage: tsx delete-resource-model-test.ts <projectDir>
 */
...
if (!dir) {
  process.stderr.write("usage: delete-resource-model-test.ts <projectDir>\n");
  process.exit(2);
}
const target = resolve(dir, "tests/models/Resource.test.ts");
